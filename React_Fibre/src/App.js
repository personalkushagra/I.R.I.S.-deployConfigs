    ...
    <>
      ...
      <ScrollControls pages={6} damping={0.1}>
        ...
        <Scroll html style={{width: '100%'}}>
          <h1 className='title' style={{ color: '#cdcbca',position: 'absolute', top: `65vh`,left: '50%', fontSize: '13em', transform: `translate(-50%,-50%)` }}>IRIS</h1>
          
          <div className='row' style={{ position: 'absolute', top: `132vh`}}>
            <h2>Section Intro</h2>
            <p style={{ maxWidth: '400px' }}>This is where the main thing goes about IRIS</p>
            <button>Read more(non responsive rn)</button>
          </div>

          <div className='row' style={{ position: 'absolute', top: `230vh`}}>
            <div className='col' style={{ position: 'absolute', right: `40px`, width: "540px"}}>
              <h2 style={{ maxWidth: "440px" }}>Section 2</h2>
              <p style={{ maxWidth: '440px' }}>This will contain another page</p>                
